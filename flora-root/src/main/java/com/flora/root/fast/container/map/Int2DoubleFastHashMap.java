...
import com.flora.root.fast.container.consumer.Int2DoubleConsumer;
 ...
 */
@ThreadFragile
public class Int2DoubleFastHashMap
    ...
    public Int2DoubleFastHashMap() {
        this(16, 0.75f);
    }

    public Int2DoubleFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Int2DoubleFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Int2DoubleConsumer action) {
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Integer, Double>> {
        int pos = 0;
    ...
    private final class EntrySet
        ...
        public boolean remove(Object o) {
            ...
            Int2DoubleFastHashMap.this.remove(kk);
            return true;
        }
    }
