...
class Long2CharFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Long2CharFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Long2CharFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Long2CharFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Long2CharFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Long2CharFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Long2CharFastHashMap(16, 1.5f));
    }

    @Test
    void putAndGet() {
        var map = new Long2CharFastHashMap();
    ...
    void shouldRehashWhenExceedingCapacity() {
        var map = new Long2CharFastHashMap(4, 0.75f);
