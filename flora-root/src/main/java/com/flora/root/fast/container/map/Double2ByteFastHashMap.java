...
import com.flora.root.fast.container.consumer.Double2ByteConsumer;
 ...
 */
@ThreadFragile
public class Double2ByteFastHashMap
    ...
    public Double2ByteFastHashMap() {
        this(16, 0.75f);
    }

    public Double2ByteFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Double2ByteFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Double2ByteConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Double, Byte> {
        double k;
        byte v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Double, Byte>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Double, Byte>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Double2ByteFastHashMap.this.remove(kk);
            return true;
        }
    }
