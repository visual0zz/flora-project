...
import com.flora.root.fast.container.consumer.Char2ByteConsumer;
 ...
 */
@ThreadFragile
public class Char2ByteFastHashMap
    ...
    public Char2ByteFastHashMap() {
        this(16, 0.75f);
    }

    public Char2ByteFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Char2ByteFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Char2ByteConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Character, Byte> {
        char k;
        byte v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Character, Byte>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Character, Byte>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Char2ByteFastHashMap.this.remove(kk);
            return true;
        }
    }
