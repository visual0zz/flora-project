...
class Short2LongFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Short2LongFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Short2LongFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Short2LongFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Short2LongFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Short2LongFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Short2LongFastHashMap(16, 1.5f));
    }

    @Test
    void putAndGet() {
        var map = new Short2LongFastHashMap();
    ...
    void shouldRehashWhenExceedingCapacity() {
        var map = new Short2LongFastHashMap(4, 0.75f);
        for (int i = 1; i <= 300; i++) {
