...
import com.flora.root.fast.container.consumer.Char2CharConsumer;
 ...
 */
@ThreadFragile
public class Char2CharFastHashMap
    ...
    public Char2CharFastHashMap() {
        this(16, 0.75f);
    }

    public Char2CharFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Char2CharFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Char2CharConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Character, Character> {
        char k;
        char v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Character, Character>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Character, Character>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Char2CharFastHashMap.this.remove(kk);
            return true;
        }
    }
