...
import com.flora.root.fast.container.consumer.Char2DoubleConsumer;
 ...
 */
@ThreadFragile
public class Char2DoubleFastHashMap
    ...
    public Char2DoubleFastHashMap() {
        this(16, 0.75f);
    }

    public Char2DoubleFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Char2DoubleFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Char2DoubleConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Character, Double> {
        char k;
        double v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Character, Double>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Character, Double>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Char2DoubleFastHashMap.this.remove(kk);
            return true;
        }
    }
