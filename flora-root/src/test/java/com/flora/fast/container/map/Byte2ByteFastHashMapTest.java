...
class Byte2ByteFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Byte2ByteFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Byte2ByteFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Byte2ByteFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Byte2ByteFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Byte2ByteFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Byte2ByteFastHashMap(16, 1.5f));
    }
    ...
    void shouldRehashWhenExceedingCapacity() {
        var map = new Byte2ByteFastHashMap(4, 0.75f);
        for (int i = 1; i <= 100; i++) {
