...
class Byte2LongFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Byte2LongFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Byte2LongFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Byte2LongFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Byte2LongFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Byte2LongFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Byte2LongFastHashMap(16, 1.5f));
    }

    @Test
    void putAndGet() {
        var map = new Byte2LongFastHashMap();
    ...
    void shouldRehashWhenExceedingCapacity() {
        var map = new Byte2LongFastHashMap(4, 0.75f);
        for (int i = 1; i <= 100; i++) {
