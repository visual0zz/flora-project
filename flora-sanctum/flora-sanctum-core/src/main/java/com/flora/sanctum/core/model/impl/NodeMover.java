...
public final class NodeMover {
    ...
    private String computeOrder(UUID newParent, UUID beforeUuid, UUID self) {
        ...
        sibs.remove(self);
        sibs.sort((a, b) -> DavidGreenspanFractionalIndex.compare(ctx.orderOf(a), ctx.orderOf(b)));
        ...
        return DavidGreenspanFractionalIndex.betweenJittered(prevOrder, nextOrder);
    }
