package com.flora.root.entropy.compress;
 ...
 * 作为压缩域独立的算法注册表。每个实例即一个独立注册表；算法工厂须通过
 * {@link AlgorithmFactory#registerTo()} 自述注册到本类，否则注册会被拒绝。</p>
 */
@ModuleEntry
public class CompressorAlgorithmFactoryRegister extends AbstractAlgorithmFactoryRegister {

    public CompressorAlgorithmFactoryRegister() {}
}
