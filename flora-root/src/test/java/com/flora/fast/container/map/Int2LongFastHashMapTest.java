...
class Int2LongFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Int2LongFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Int2LongFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Int2LongFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Int2LongFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Int2LongFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Int2LongFastHashMap(16, 1.5f));
    }
    ...
    void shouldRehashWhenExceedingCapacity() {
        var map = new Int2LongFastHashMap(4, 0.75f);
