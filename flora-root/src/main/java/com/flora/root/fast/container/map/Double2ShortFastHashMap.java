...
import com.flora.root.fast.container.consumer.Double2ShortConsumer;
 ...
 */
@ThreadFragile
public class Double2ShortFastHashMap
    ...
    public Double2ShortFastHashMap() {
        this(16, 0.75f);
    }

    public Double2ShortFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Double2ShortFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Double2ShortConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Double, Short> {
        double k;
        short v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Double, Short>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Double, Short>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Double2ShortFastHashMap.this.remove(kk);
            return true;
        }
    }
