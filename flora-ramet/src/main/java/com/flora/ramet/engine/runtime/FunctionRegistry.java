 ...
 * 始终与函数定义同步。{@link com.flora.ramet.engine.model.Lson.Keyword} 的三值检查
 * 和 {@link com.flora.ramet.engine.model.Lson} 的指令表达式解析器均基于该映射判断关键字/运算符。
 *
 * <p>内置函数由 {@link BuiltinFunc} 枚举统一管理（一个 class 文件替代 25+ 匿名内部类），
 * 外部模块可通过 Java SPI 机制扩展：
 * <ol>
 *   <li>实现 {@link TemplateFunction} 接口</li>
 *   <li>在 {@code META-INF/services/com.flora.ramet.TemplateFunction} 文件中声明实现类的全限定名</li>
 * </ol>
 *
