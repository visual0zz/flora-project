...
import com.flora.root.fast.container.consumer.Double2FloatConsumer;
 ...
 */
@ThreadFragile
public class Double2FloatFastHashMap
    ...
    public Double2FloatFastHashMap() {
        this(16, 0.75f);
    }

    public Double2FloatFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Double2FloatFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Double2FloatConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Double, Float> {
        double k;
        float v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Double, Float>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Double, Float>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Double2FloatFastHashMap.this.remove(kk);
            return true;
        }
    }
