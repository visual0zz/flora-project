 ...
 */
@ReadOnly
public final class FastTupleFDD implements Serializable, Cloneable, Comparable<FastTupleFDD> {
    @Serial
     ...
     * @param v3 第3个元素
     */
    public FastTupleFDD(float v1,double v2,double v3){
        this.v1 = v1;
        this.v2 = v2;
        this.v3 = v3;
    }
     ...
     */
    @Override
    public int compareTo(FastTupleFDD that) {
