...
import com.flora.root.fast.container.consumer.Long2CharConsumer;
 ...
 */
@ThreadFragile
public class Long2CharFastHashMap
    ...
    public Long2CharFastHashMap() {
        this(16, 0.75f);
    }

    public Long2CharFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Long2CharFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Long2CharConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Long, Character> {
        long k;
        char v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Long, Character>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Long, Character>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Long2CharFastHashMap.this.remove(kk);
            return true;
        }
    }
