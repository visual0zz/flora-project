...
class Int2DoubleFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Int2DoubleFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Int2DoubleFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Int2DoubleFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Int2DoubleFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Int2DoubleFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Int2DoubleFastHashMap(16, 1.5f));
    }

    @Test
    void putAndGet() {
        var map = new Int2DoubleFastHashMap();
    ...
    void shouldRehashWhenExceedingCapacity() {
        var map = new Int2DoubleFastHashMap(4, 0.75f);
