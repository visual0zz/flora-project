...
import com.flora.root.fast.container.consumer.Long2ShortConsumer;
 ...
 */
@ThreadFragile
public class Long2ShortFastHashMap
    ...
    public Long2ShortFastHashMap() {
        this(16, 0.75f);
    }

    public Long2ShortFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Long2ShortFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Long2ShortConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Long, Short> {
        long k;
        short v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Long, Short>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Long, Short>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Long2ShortFastHashMap.this.remove(kk);
            return true;
        }
    }
