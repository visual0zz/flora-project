...
class SessionTest {
    ...
    void executeToolsRunsAndReturnsReceipts() {
        ...
        String text = ((com.flora.ai.api.ContentBlock.Text) receipt.content().get(0)).text();
    ...
    void multimodalTurnInput() {
        ...
        s.turn(List.of(new com.flora.ai.api.ContentBlock.Text("what"),
                new com.flora.ai.api.ContentBlock.Image("data:image/png;base64,zz", "image/png")));
        assertEquals(2, ctx.size());
