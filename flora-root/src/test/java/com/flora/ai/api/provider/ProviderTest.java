...
class ProviderTest {
    ...
    void openAiProvider() {
        ...
        assertEquals(ApiSchema.OPENAI_OFFICIAL, p.apiKind());
    }
    ...
    void openAiLikeProvider() {
        ...
        assertEquals(ApiSchema.OPENAI_LIKE, p.apiKind());
    }
    ...
    void anthropicProvider() {
        ...
        assertEquals(ApiSchema.ANTHROPIC_OFFICIAL, p.apiKind());
    }
    ...
    void geminiProvider() {
        ...
        assertEquals(ApiSchema.GEMINI_OFFICIAL, p.apiKind());
    }
    ...
    void deepSeekProvider() {
        ...
        assertEquals(ApiSchema.DEEPSEEK_OFFICIAL, p.apiKind());
    }
}
