...
class Char2ShortFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Char2ShortFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Char2ShortFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Char2ShortFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Char2ShortFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Char2ShortFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Char2ShortFastHashMap(16, 1.5f));
    }

    @Test
    void putAndGet() {
        var map = new Char2ShortFastHashMap();
    ...
    void shouldRehashWhenExceedingCapacity() {
        var map = new Char2ShortFastHashMap(4, 0.75f);
