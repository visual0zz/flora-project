 ...
 * <p>
 * magic = 8 字节 ASCII "Zhao zhi"。version 字段统一为 1（VERSION_1，第一代格式），
 * 块类型由 flags 区分（FLAG_CIPHER / FLAG_PLAINTEXT）。
 * <ul>
 *   <li><b>明文块</b>（仅 manifest）：头 = magic(8)+version(1)+flags(1)+uuid(16)，
 *       payload 从 {@link #PLAINTEXT_HEADER_LEN} 开始，尾附 MAC（见 {@link com.flora.sanctum.model.impl.ManifestStore}）。</li>
 *   <li><b>密文块</b>：头 = magic(8)+version(1)+flags(1)+uuid(16)+nonce(12)+keyId(8)，
