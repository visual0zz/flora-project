...
class Char2ByteFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Char2ByteFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Char2ByteFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Char2ByteFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Char2ByteFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Char2ByteFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Char2ByteFastHashMap(16, 1.5f));
    }

    @Test
    void putAndGet() {
        var map = new Char2ByteFastHashMap();
    ...
    void shouldRehashWhenExceedingCapacity() {
        var map = new Char2ByteFastHashMap(4, 0.75f);
