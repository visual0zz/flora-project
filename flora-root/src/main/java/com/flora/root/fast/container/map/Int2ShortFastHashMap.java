...
import com.flora.root.fast.container.consumer.Int2ShortConsumer;
 ...
 */
@ThreadFragile
public class Int2ShortFastHashMap
    ...
    public Int2ShortFastHashMap() {
        this(16, 0.75f);
    }

    public Int2ShortFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Int2ShortFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Int2ShortConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Integer, Short> {
        int k;
        short v;
        int pos;
        boolean zero;
    ...
    private final class EntrySet
        ...
        public boolean remove(Object o) {
            ...
            Int2ShortFastHashMap.this.remove(kk);
            return true;
        }
    }
