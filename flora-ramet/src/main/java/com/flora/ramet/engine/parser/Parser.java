package com.flora.ramet.engine.parser;
import com.flora.ramet.engine.ast.Node;
import com.flora.ramet.engine.ast.VarNode;
import com.flora.ramet.engine.ast.MetaNode;
import com.flora.ramet.engine.ast.ForNode;
import com.flora.ramet.engine.ast.BreakNode;
import com.flora.ramet.engine.ast.IfNode;
import com.flora.ramet.engine.ast.ContinueNode;
import com.flora.ramet.engine.ast.IncludeNode;
import com.flora.ramet.engine.ast.MacroDefNode;
import com.flora.ramet.engine.ast.MacroCallNode;
import com.flora.ramet.engine.ast.CommentNode;
import com.flora.ramet.engine.ast.TextNode;
...
import com.flora.ramet.engine.model.Token;
import com.flora.ramet.engine.ast.*;
 ...
 * </ol>
 *
 * <p>支持的 AST 节点类型见 {@code com.flora.ramet.engine.ast} 包。
 *
 * @see com.flora.ramet.engine.ast.Node
 */
public class Parser {
    List<Token> toks;
    String source;
