 ...
 */
@ReadOnly
public final class FastTupleIDD implements Serializable, Cloneable, Comparable<FastTupleIDD> {
    @Serial
     ...
     * @param v3 第3个元素
     */
    public FastTupleIDD(int v1,double v2,double v3){
        this.v1 = v1;
        this.v2 = v2;
        this.v3 = v3;
    }
     ...
     */
    @Override
    public int compareTo(FastTupleIDD that) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FastTupleIDD that)) return false;
