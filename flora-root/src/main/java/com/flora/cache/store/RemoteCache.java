 ...
 * （内部移除钩子 {@link com.flora.cache.MemoryCache#setInternalRemovalListener} 仅由本地托管的
 * {@link com.flora.cache.MemoryCache} 实现（如 {@link ConcurrentHashMapCache}）持有；本类不实现该接口，
