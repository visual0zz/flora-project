 ...
 * </ul>
 *
 * <p>内置函数通过 {@link com.flora.ramet.engine.runtime.FunctionRegistry} 注册。
 * 外部模块可通过 Java SPI 机制扩展：在 {@code META-INF/services/com.flora.ramet.TemplateFunction}
 * 中声明实现类的全限定名。
 *
 * @see com.flora.ramet.engine.runtime.FunctionRegistry
 */
