...
import com.flora.root.fast.container.consumer.Double2LongConsumer;
 ...
 */
@ThreadFragile
public class Double2LongFastHashMap
    ...
    public Double2LongFastHashMap() {
        this(16, 0.75f);
    }

    public Double2LongFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Double2LongFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Double2LongConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Double, Long> {
        double k;
        long v;
        int pos;
        boolean zero;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Double, Long>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Double2LongFastHashMap.this.remove(kk);
            return true;
        }
    }
