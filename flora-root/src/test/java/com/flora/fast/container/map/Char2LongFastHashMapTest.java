...
class Char2LongFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Char2LongFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Char2LongFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Char2LongFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Char2LongFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Char2LongFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Char2LongFastHashMap(16, 1.5f));
    }

    @Test
    void putAndGet() {
        var map = new Char2LongFastHashMap();
    ...
    void shouldRehashWhenExceedingCapacity() {
        var map = new Char2LongFastHashMap(4, 0.75f);
