...
class Double2ObjectFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Double2ObjectFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Double2ObjectFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Double2ObjectFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Double2ObjectFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Double2ObjectFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Double2ObjectFastHashMap(16, 1.5f));
    }

    @Test
    void putAndGet() {
        var map = new Double2ObjectFastHashMap();
    ...
    void shouldRehashWhenExceedingCapacity() {
        var map = new Double2ObjectFastHashMap(4, 0.75f);
