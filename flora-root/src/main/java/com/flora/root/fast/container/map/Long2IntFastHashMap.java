...
import com.flora.root.fast.container.consumer.Long2IntConsumer;
 ...
 */
@ThreadFragile
public class Long2IntFastHashMap
    ...
    public Long2IntFastHashMap() {
        this(16, 0.75f);
    }

    public Long2IntFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Long2IntFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Long2IntConsumer action) {
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Long, Integer>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Long2IntFastHashMap.this.remove(kk);
            return true;
        }
    }
