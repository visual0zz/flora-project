...
import com.flora.root.fast.container.consumer.Char2ShortConsumer;
 ...
 */
@ThreadFragile
public class Char2ShortFastHashMap
    ...
    public Char2ShortFastHashMap() {
        this(16, 0.75f);
    }

    public Char2ShortFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Char2ShortFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Char2ShortConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Character, Short> {
        char k;
        short v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Character, Short>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Character, Short>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Char2ShortFastHashMap.this.remove(kk);
            return true;
        }
    }
