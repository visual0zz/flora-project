...
import com.flora.crypto.newcore.constant.AsymmetricKeyType;
...
import com.flora.crypto.newcore.interfaces.material.kem.SecretWithEncapsulation;
...
import com.flora.crypto.newcore.param.HkdfParameters;
...
public final class AgreementBasedKem implements KeyEncapsulationMechanism {
    ...
    private byte[] deriveSecret(byte[] z) {
        DerivationFunction kdf = new HkdfDerivationFunction(com.flora.crypto.newcore.bridge.JdkMac.of("HmacSHA256"));
    ...
    private final class EncapsulatorImpl implements Encapsulator {
        ...
        @Override
        public com.flora.crypto.newcore.interfaces.material.param.CipherParameter getPublicKey() {
            return recipientPub;
        }
    }
