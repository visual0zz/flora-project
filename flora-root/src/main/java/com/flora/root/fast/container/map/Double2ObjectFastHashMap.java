...
import com.flora.root.fast.container.consumer.Double2ObjectConsumer;
 ...
 */
@ThreadFragile
public class Double2ObjectFastHashMap
    extends AbstractMap<Double, Object> {
    ...
    public Double2ObjectFastHashMap() {
        this(16, 0.75f);
    }

    public Double2ObjectFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Double2ObjectFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public Object getOrDefault(double key, Object defaultValue) {
    ...
    public void forEach(Double2ObjectConsumer action) {
    ...
    /** 返回条目集合视图。 */
    @Override
    public Set<Map.Entry<Double, Object>> entrySet() {
        return new EntrySet();
    }
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Double, Object>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Double, Object>> {
        @Override
        ...
        public boolean contains(Object o) {
            ...
            Map.Entry<Double, Object> e = (Map.Entry<Double, Object>) o;
            Object k = e.getKey();
        ...
        public boolean remove(Object o) {
            ...
            Double2ObjectFastHashMap.this.remove(kk);
            return true;
        }
    }
