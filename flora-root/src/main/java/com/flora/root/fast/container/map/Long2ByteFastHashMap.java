...
import com.flora.root.fast.container.consumer.Long2ByteConsumer;
 ...
 */
@ThreadFragile
public class Long2ByteFastHashMap
    ...
    public Long2ByteFastHashMap() {
        this(16, 0.75f);
    }

    public Long2ByteFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Long2ByteFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Long2ByteConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Long, Byte> {
        long k;
        byte v;
        int pos;
        boolean zero;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Long, Byte>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Long2ByteFastHashMap.this.remove(kk);
            return true;
        }
    }
