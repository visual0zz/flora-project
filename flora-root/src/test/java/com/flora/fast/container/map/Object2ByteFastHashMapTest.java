...
class Object2ByteFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Object2ByteFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Object2ByteFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Object2ByteFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Object2ByteFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Object2ByteFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Object2ByteFastHashMap(16, 1.5f));
    }

    @Test
    void putAndGet() {
        var map = new Object2ByteFastHashMap();
        assertEquals((byte)-1, map.putRaw(k(2), v(200)));
        assertEquals((byte)-1, map.putRaw(k(1), v(100)));
        assertEquals((byte)-1, map.putRaw(k(3), v(300)));
        ...
        assertEquals((byte)-1, map.putRaw(k(4), v(100)));
        ...
        assertEquals((byte)-1, map.getRaw(k(42)));
    ...
    void remove() {
        ...
        assertEquals((byte)-1, map.getRaw(k(1)));
        assertEquals(v(200), map.getRaw(k(2)));
        assertEquals(1, map.size());

        assertEquals((byte)-1, map.removeRaw(k(99)));
    ...
    void clear() {
        ...
        assertEquals((byte)-1, map.getRaw(k(1)));
        assertEquals((byte)-1, map.getRaw(k(2)));
        assertEquals((byte)-1, map.getRaw(k(3)));
    }
    ...
    void defaultReturnValue() {
        ...
        map.defaultReturnValue((byte)-1);
        assertEquals((byte)-1, map.defaultReturnValue());
        assertEquals((byte)-1, map.getRaw(k(999)));
    }

    @Test
    void shouldRehashWhenExceedingCapacity() {
        var map = new Object2ByteFastHashMap(4, 0.75f);
        for (int i = 1; i <= 1000; i++) {
            assertEquals((byte)-1, map.putRaw(k(i), v(i * 10)));
        }
    ...
    void shouldReuseDeletedSlots() {
        ...
        for (int i = 20; i < 30; i++) {
            assertEquals((byte)-1, map.putRaw(k(i), v(i)));
        }
        assertEquals(20, map.size());
        for (int i = 0; i < 10; i++) {
            assertEquals((byte)-1, map.getRaw(k(i)));
        }
        for (int i = 10; i < 30; i++) {
    ...
    void shouldHandleCollisions() {
        ...
        for (int i = 0; i < 1000; i++) {
            assertEquals((byte)-1, map.putRaw(k(i), v(i * 2)));
        }
        for (int i = 0; i < 1000; i++) {
