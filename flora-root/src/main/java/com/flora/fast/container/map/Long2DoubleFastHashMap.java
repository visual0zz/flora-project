 ...
 */
@ThreadFragile
public class Long2DoubleFastHashMap
    ...
    public Long2DoubleFastHashMap() {
        this(16, 0.75f);
    }

    public Long2DoubleFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Long2DoubleFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Long2DoubleConsumer action) {
    ...
    private static final class FastEntry
            implements Map.Entry<Long, Double> {
        long k;
        double v;
    ...
    private final class EntrySet
        ...
        public boolean remove(Object o) {
            ...
            Long2DoubleFastHashMap.this.remove(kk);
            return true;
        }
    }
