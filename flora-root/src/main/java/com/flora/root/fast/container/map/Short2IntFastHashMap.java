...
import com.flora.root.fast.container.consumer.Short2IntConsumer;
 ...
 */
@ThreadFragile
public class Short2IntFastHashMap
    ...
    public Short2IntFastHashMap() {
        this(16, 0.75f);
    }

    public Short2IntFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Short2IntFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Short2IntConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Short, Integer> {
        short k;
        int v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Short, Integer>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Short, Integer>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Short2IntFastHashMap.this.remove(kk);
            return true;
        }
    }
