...
class JsonSpecComplianceTest {
    ...
    void jsonPathKeepsDuplicateValues() {
        ...
        var r = com.flora.codec.JsonUtil.evalAll(java.util.List.of(1, 1, 1), "$[*]");
        assertEquals(3, r.size());
    }

    @Test
    void jsonPathKeepsDuplicateNodesAcrossSteps() {
        var r = com.flora.codec.JsonUtil.evalAll(
    ...
    void countWithoutArgumentThrows() {
        assertThrows(IllegalStateException.class,
                () -> com.flora.codec.JsonUtil.evalAll(java.util.List.of(1, 2), "$[?(count() > 0)]"));
    }
    ...
    void countWithArgumentWorks() {
        ...
        var r1 = com.flora.codec.JsonUtil.evalAll(books, "$[?(count(@.n) == 1)]");
        assertEquals(2, r1.size());
        // @.n[*] 展开为 3 个节点，count == 3
        var r2 = com.flora.codec.JsonUtil.evalAll(books, "$[?(count(@.n[*]) == 3)]");
