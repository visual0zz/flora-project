...
import com.flora.root.fast.container.consumer.Short2DoubleConsumer;
 ...
 */
@ThreadFragile
public class Short2DoubleFastHashMap
    ...
    public Short2DoubleFastHashMap() {
        this(16, 0.75f);
    }

    public Short2DoubleFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Short2DoubleFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Short2DoubleConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Short, Double> {
        short k;
        double v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Short, Double>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Short, Double>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Short2DoubleFastHashMap.this.remove(kk);
            return true;
        }
    }
