...
import com.flora.root.fast.container.consumer.Short2ByteConsumer;
 ...
 */
@ThreadFragile
public class Short2ByteFastHashMap
    ...
    public Short2ByteFastHashMap() {
        this(16, 0.75f);
    }

    public Short2ByteFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Short2ByteFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Short2ByteConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Short, Byte> {
        short k;
        byte v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Short, Byte>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Short, Byte>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Short2ByteFastHashMap.this.remove(kk);
            return true;
        }
    }
