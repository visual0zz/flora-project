...
class Object2ObjectFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Object2ObjectFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Object2ObjectFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Object2ObjectFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Object2ObjectFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Object2ObjectFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Object2ObjectFastHashMap(16, 1.5f));
    }
    ...
    void shouldRehashWhenExceedingCapacity() {
        var map = new Object2ObjectFastHashMap(4, 0.75f);
