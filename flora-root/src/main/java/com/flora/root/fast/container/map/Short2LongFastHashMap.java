...
import com.flora.root.fast.container.consumer.Short2LongConsumer;
 ...
 */
@ThreadFragile
public class Short2LongFastHashMap
    ...
    public Short2LongFastHashMap() {
        this(16, 0.75f);
    }

    public Short2LongFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Short2LongFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Short2LongConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Short, Long> {
        short k;
        long v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Short, Long>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Short, Long>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Short2LongFastHashMap.this.remove(kk);
            return true;
        }
    }
