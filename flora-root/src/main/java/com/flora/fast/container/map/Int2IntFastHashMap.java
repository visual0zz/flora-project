 ...
 */
@ThreadFragile
public class Int2IntFastHashMap
    ...
    public Int2IntFastHashMap() {
        this(16, 0.75f);
    }

    public Int2IntFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Int2IntFastHashMap(int initialCapacity, float loadFactor) {
    ...
    private final class EntrySet
        ...
        public boolean remove(Object o) {
            ...
            Int2IntFastHashMap.this.remove(kk);
            return true;
        }
    }
