...
class Double2CharFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Double2CharFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Double2CharFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Double2CharFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Double2CharFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Double2CharFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Double2CharFastHashMap(16, 1.5f));
    }

    @Test
    void putAndGet() {
        var map = new Double2CharFastHashMap();
    ...
    void shouldRehashWhenExceedingCapacity() {
        var map = new Double2CharFastHashMap(4, 0.75f);
