...
class Long2DoubleFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Long2DoubleFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Long2DoubleFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Long2DoubleFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Long2DoubleFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Long2DoubleFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Long2DoubleFastHashMap(16, 1.5f));
    }
    ...
    void shouldRehashWhenExceedingCapacity() {
        var map = new Long2DoubleFastHashMap(4, 0.75f);
