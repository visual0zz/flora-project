...
import com.flora.root.fast.container.consumer.Long2FloatConsumer;
 ...
 */
@ThreadFragile
public class Long2FloatFastHashMap
    ...
    public Long2FloatFastHashMap() {
        this(16, 0.75f);
    }

    public Long2FloatFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Long2FloatFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Long2FloatConsumer action) {
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Long, Float>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Long, Float>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Long2FloatFastHashMap.this.remove(kk);
            return true;
        }
    }
