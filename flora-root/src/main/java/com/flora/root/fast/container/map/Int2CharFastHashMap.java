...
import com.flora.root.fast.container.consumer.Int2CharConsumer;
 ...
 */
@ThreadFragile
public class Int2CharFastHashMap
    ...
    public Int2CharFastHashMap() {
        this(16, 0.75f);
    }

    public Int2CharFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Int2CharFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Int2CharConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Integer, Character> {
        int k;
        char v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Integer, Character>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Integer, Character>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Int2CharFastHashMap.this.remove(kk);
            return true;
        }
    }
