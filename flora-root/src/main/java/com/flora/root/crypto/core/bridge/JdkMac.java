 ...
 */
@ThreadFragile
public final class JdkMac implements com.flora.root.crypto.core.interfaces.algorithm.Mac {
    ...
    @Override
    public AlgorithmFactory<? extends com.flora.root.crypto.core.interfaces.algorithm.Mac> factory() {
        return FACTORY;
    }

    public static final AlgorithmFactory<com.flora.root.crypto.core.interfaces.algorithm.Mac> FACTORY = new AlgorithmFactory<>() {
        @Override
        ...
        @Override
        public com.flora.root.crypto.core.interfaces.algorithm.Mac construct(
