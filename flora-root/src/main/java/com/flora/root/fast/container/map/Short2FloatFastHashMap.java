...
import com.flora.root.fast.container.consumer.Short2FloatConsumer;
 ...
 */
@ThreadFragile
public class Short2FloatFastHashMap
    ...
    public Short2FloatFastHashMap() {
        this(16, 0.75f);
    }

    public Short2FloatFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Short2FloatFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Short2FloatConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Short, Float> {
        short k;
        float v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Short, Float>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Short, Float>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Short2FloatFastHashMap.this.remove(kk);
            return true;
        }
    }
