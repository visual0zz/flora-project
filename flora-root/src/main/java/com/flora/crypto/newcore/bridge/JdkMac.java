 ...
 */
@ThreadFragile
public final class JdkMac implements com.flora.crypto.newcore.interfaces.algorithm.Mac {
    ...
    @Override
    public AlgorithmFactory<? extends com.flora.crypto.newcore.interfaces.algorithm.Mac> factory() {
        return FACTORY;
    }

    public static final AlgorithmFactory<com.flora.crypto.newcore.interfaces.algorithm.Mac> FACTORY = new AlgorithmFactory<>() {
        @Override
        ...
        @Override
        public com.flora.crypto.newcore.interfaces.algorithm.Mac construct(
