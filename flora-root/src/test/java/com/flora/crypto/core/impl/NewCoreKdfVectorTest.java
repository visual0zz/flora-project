...
class NewCoreKdfVectorTest {
  ...
  void pbkdf2Rfc6070() {
    Pbkdf2DerivationFunction pbkdf2 = new Pbkdf2DerivationFunction(
        new HMac(com.flora.crypto.core.bridge.JdkDigest.of("SHA-1")));
    pbkdf2.init(new com.flora.crypto.core.param.Pbkdf2Parameters(
  ...
  void hkdfRfc5869() {
    HkdfDerivationFunction hkdf = new HkdfDerivationFunction(
        new HMac(com.flora.crypto.core.bridge.JdkDigest.of("SHA-256")));
    hkdf.init(new com.flora.crypto.core.param.HkdfParameters(
  ...
  void bcryptMatchesCore() {
    ...
    bcrypt.init(new com.flora.crypto.core.param.BCryptParameters(password, salt, rounds));
    byte[] out = new byte[dkLen];
