...
import com.flora.root.fast.container.consumer.Object2IntConsumer;
 ...
 */
@ThreadFragile
public class Object2IntFastHashMap
    extends AbstractMap<Object, Integer> {
    ...
    public Object2IntFastHashMap() {
        this(16, 0.75f);
    }

    public Object2IntFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Object2IntFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public int putRaw(Object key, int value) {
        if (key == null) {
            if (containsZeroKey) {
    ...
    public Integer put(Object key, Integer value) {
        if (!containsKey(key)) {
            putRaw(key, (int) value);
            return null;
        }
        return putRaw(key, (int) value);
    }

    public int removeRaw(Object key) {
        if (key == null) {
            if (containsZeroKey) {
                int old = values[values.length - 1];
    ...
    public void forEach(Object2IntConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Object, Integer> {
        Object k;
        int v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Object, Integer>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Object, Integer>> {
        @Override
        ...
        public boolean contains(Object o) {
            ...
            Map.Entry<Object, Integer> e = (Map.Entry<Object, Integer>) o;
            Object k = e.getKey();
        ...
        public boolean remove(Object o) {
            ...
            Object2IntFastHashMap.this.remove(kk);
            return true;
        }
    }
