...
import com.flora.root.fast.container.consumer.Double2IntConsumer;
 ...
 */
@ThreadFragile
public class Double2IntFastHashMap
    ...
    public Double2IntFastHashMap() {
        this(16, 0.75f);
    }

    public Double2IntFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Double2IntFastHashMap(int initialCapacity, float loadFactor) {
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Double, Integer>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Double, Integer>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Double2IntFastHashMap.this.remove(kk);
            return true;
        }
    }
