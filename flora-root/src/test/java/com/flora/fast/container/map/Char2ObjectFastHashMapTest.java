...
class Char2ObjectFastHashMapTest {
    ...
    void invalidArguments() {
        assertThrows(IllegalArgumentException.class, () -> new Char2ObjectFastHashMap(0));
        assertThrows(IllegalArgumentException.class, () -> new Char2ObjectFastHashMap(-1));
        assertThrows(IllegalArgumentException.class, () -> new Char2ObjectFastHashMap(16, 0f));
        assertThrows(IllegalArgumentException.class, () -> new Char2ObjectFastHashMap(16, 1f));
        assertThrows(IllegalArgumentException.class, () -> new Char2ObjectFastHashMap(16, -0.1f));
        assertThrows(IllegalArgumentException.class, () -> new Char2ObjectFastHashMap(16, 1.5f));
    }

    @Test
    void putAndGet() {
        var map = new Char2ObjectFastHashMap();
    ...
    void shouldRehashWhenExceedingCapacity() {
        var map = new Char2ObjectFastHashMap(4, 0.75f);
