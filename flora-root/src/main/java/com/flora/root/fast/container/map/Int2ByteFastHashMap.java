...
import com.flora.root.fast.container.consumer.Int2ByteConsumer;
 ...
 */
@ThreadFragile
public class Int2ByteFastHashMap
    ...
    public Int2ByteFastHashMap() {
        this(16, 0.75f);
    }

    public Int2ByteFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Int2ByteFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Int2ByteConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Integer, Byte> {
        int k;
        byte v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Integer, Byte>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Integer, Byte>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Int2ByteFastHashMap.this.remove(kk);
            return true;
        }
    }
