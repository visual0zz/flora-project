...
import com.flora.root.fast.container.consumer.Double2CharConsumer;
 ...
 */
@ThreadFragile
public class Double2CharFastHashMap
    ...
    public Double2CharFastHashMap() {
        this(16, 0.75f);
    }

    public Double2CharFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Double2CharFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public void forEach(Double2CharConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Double, Character> {
        double k;
        char v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Double, Character>> {
        int pos = 0;
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Double, Character>> {
        @Override
        ...
        public boolean remove(Object o) {
            ...
            Double2CharFastHashMap.this.remove(kk);
            return true;
        }
    }
