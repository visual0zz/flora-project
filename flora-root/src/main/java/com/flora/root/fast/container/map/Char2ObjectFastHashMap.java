...
import com.flora.root.fast.container.consumer.Char2ObjectConsumer;
 ...
 */
@ThreadFragile
public class Char2ObjectFastHashMap
    extends AbstractMap<Character, Object> {
    ...
    public Char2ObjectFastHashMap() {
        this(16, 0.75f);
    }

    public Char2ObjectFastHashMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    public Char2ObjectFastHashMap(int initialCapacity, float loadFactor) {
    ...
    public Object getOrDefault(char key, Object defaultValue) {
    ...
    public void forEach(Char2ObjectConsumer action) {
    ...
    private final class FastEntry
            implements Map.Entry<Character, Object> {
        char k;
        Object v;
        int pos;
        boolean zero;
    ...
    private final class FastIterator
            implements Iterator<Map.Entry<Character, Object>> {
        int pos = 0;
        ...
        @Override
        public Map.Entry<Character, Object> next() {
    ...
    private final class EntrySet
            extends AbstractSet<Map.Entry<Character, Object>> {
        @Override
        public Iterator<Map.Entry<Character, Object>> iterator() {
        ...
        public boolean contains(Object o) {
            ...
            Map.Entry<Character, Object> e = (Map.Entry<Character, Object>) o;
            Object k = e.getKey();
        ...
        public boolean remove(Object o) {
            ...
            Char2ObjectFastHashMap.this.remove(kk);
            return true;
        }
    }
